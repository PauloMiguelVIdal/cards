...
function Cards({nome,valorCompra,aluguel,casa1,casa2,casa3,casa4,hotel,proprietario}){
    return(
        <div className="bg-indigo-500 w-[200px] min-h-[110px] border-[20px] rounded-[20px] m-[5px]">
        <h3>{nome}</h3>
    ...
    function ListCards(){   
        ...
        return(
           ...
           {dados.propriedades.map((cards)=>(
               ...
               casa4={cards.casa4}
               hotel={cards.hotel}
               proprietario={cards.proprietario}
               />   
            ))}
        </div>
    )
